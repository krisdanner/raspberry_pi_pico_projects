...
void create_http_response() {
    snprintf(http_response, sizeof(http_response),
             ...
             "  <p>Botão 1: %s</p>" // mensagem que será atualizada com o estado do botão 1
             "  <p>Botão 2: %s</p>" // mensagem que será atualizada com o estado do botão 2
             "</body>"
             "</html>\r\n",
             button1_message, button2_message); // variáveis das mensagens que vão entrar em %s e vai para a página.
}
